...
for builidng_enum_no, unique_building_name in enumerate(building_types_list):
    ...
    # Edit idf RunPeriod? to 3 years? TODO, also for baseline, only 1 year
    ...
    if name_of_control_this_run == 'EPBaseline': # 1 year only
        idf_edit_dates.idfobjects['RUNPERIOD'][0].End_Year = idf_edit_dates.idfobjects['RUNPERIOD'][0].End_Year
